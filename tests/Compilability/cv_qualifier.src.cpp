...
void
h(int i,
    int const volatile ci,
    short *ps,
    short *const volatile cps,
    short const volatile *pcs,
    short const volatile *const volatile cpcs) {
  double d = 0;
