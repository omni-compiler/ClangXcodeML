...
public:
  ...
  explicit XcodeMlVisitorBaseImpl(
      clang::MangleContext *MC, xmlNodePtr CurNode, TypeTableInfo *TTI);
...
public:
  ...
  explicit XcodeMlVisitorBase(clang::MangleContext *MC,
      xmlNodePtr Parent,
      const char *ChildName,
      TypeTableInfo *TTI = nullptr)
      : XcodeMlVisitorBaseImpl(MC,
  ...
  explicit XcodeMlVisitorBase(XcodeMlVisitorBase *p)
      : XcodeMlVisitorBaseImpl(p->mangleContext, p->curNode, p->typetableinfo),
